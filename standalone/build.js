...
<main class="wrap">
  <section class="hero no-print">
    ...
    <a class="manual-link" href="TECHNICAL_MANUAL.pdf" download style="margin-left:8px;">&#11015; Download PDF</a>
  ...
  <section id="reportArea" style="display:none;">
    ...
    <div class="tabs no-print">
      ...
      <button class="tab" onclick="showTab('pdfPanel',this)">&#11015; Download Report</button>
    </div>
